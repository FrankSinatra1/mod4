=== Plugin Name ===
Contributors: coleds
Donate link: https://bit.ly/2H4DSmq
Tags: seo,meta,keywords,description,title,post,search engine optimization,google,google webmaster tools,analytic,analytics,readability
...
3. Use the Settings -> Simple SEO screen to configure the META info for the homepage, Google webmaster tools, and Google analytic.
...
* Bugfixes
	* Fixed title, description, etc from showing a empty result (<title></title>) if it's not specified.
